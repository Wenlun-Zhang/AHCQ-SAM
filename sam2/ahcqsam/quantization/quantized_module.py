...
from .observer import MSEFastObserver, MinMaxObserver, AvgMinMaxObserver, MSEObserver, AvgMSEObserver, \
    AvgMSEFastObserver, LogAvgMSEFastObserver, SignAvgMSEFastObserver, PCTObserver, AvgMinMaxGroupObserver, \
    HybridParamObserver, LogTransformObserver
from .fake_quant import LSQPlusSignFakeQuantize, AdaRoundFakeQuantize, FixedFakeQuantize, LSQFakeQuantize, \
    LSQPlusFakeQuantize, LSQSignFakeQuantize, AdaptiveGranularityQuantize, GroupLSQFakeQuantize, HybridQuantize, LogTransformQuantize
...
ObserverDict = {
    ...
    'LogTransformObserver': LogTransformObserver
}
...
FakeQuantizeDict = {
    ...
    'LogTransformQuantize': LogTransformQuantize
}
