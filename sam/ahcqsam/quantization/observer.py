...
from .util_quant import fake_quantize_per_tensor_affine, fake_log_transform_quantize, fake_quantize_per_channel_affine, \
    fake_logquantize_per_tensor_affine, fake_hybrid_quantize_per_tensor_affine
