...
from .observer import MSEFastObserver, MinMaxObserver, AvgMinMaxObserver, MSEObserver, AvgMSEObserver, \
    LogTransformObserver, AvgMSEFastObserver, LogAvgMSEFastObserver, SignAvgMSEFastObserver, PCTObserver, \
    AvgMinMaxGroupObserver, HybridParamObserver
from .fake_quant import LSQPlusSignFakeQuantize, AdaRoundFakeQuantize, FixedFakeQuantize, LSQFakeQuantize, \
    LSQPlusFakeQuantize, LSQSignFakeQuantize, AdaptiveGranularityQuantize, LogTransformQuantize, GroupLSQFakeQuantize, \
    HybridQuantize
...
FakeQuantizeDict = {
    ...
    'LogTransformQuantize': LogTransformQuantize,  # noqa: E241
